...
- Offline fallbacks stay inside the active release cache, cache-write failure preserves valid network responses, incomplete install graphs are rejected and cleaned, and the worker script bypasses runtime caching
