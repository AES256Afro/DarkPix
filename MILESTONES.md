...
- First-person movement, crouch stealth, pixel-scaled 3D rendering, confirmed and timeout-bounded pointer-lock resume, stamina-costed direction-locked strikes that resolve at visible mid-swing, shared occupied-hand recovery rules, ranged weapons, magic, guards, parries, ripostes, sidesteps, class abilities, and an exact paused-raid readiness ledger
