...
- First-person movement, crouch stealth, pixel-scaled 3D rendering, stamina-costed direction-locked melee with shared occupied-hand recovery rules, ranged weapons, magic, guards, parries, ripostes, sidesteps, class abilities, and an exact paused-raid readiness ledger
