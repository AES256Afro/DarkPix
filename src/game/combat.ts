...
export const TRAP_WARNING_RANGE = 13;

export function trapWarningAudible(distanceSquared: number): boolean {
  return Number.isFinite(distanceSquared) && distanceSquared >= 0 && distanceSquared <= TRAP_WARNING_RANGE * TRAP_WARNING_RANGE;
}
